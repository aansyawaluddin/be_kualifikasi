...
router.post('/kualifikasi/uji-coba/mulai/:paketId', adminController.startUjiCoba);
router.post('/kualifikasi/uji-coba/selesai/:paketId', adminController.selesaiUjiCoba);
router.post('/kualifikasi/soal-real/mulai/:paketId', adminController.startSoalReal);
